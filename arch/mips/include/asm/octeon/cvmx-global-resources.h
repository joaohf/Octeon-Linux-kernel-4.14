 ...
 * elements
 * @tag: is the tag of the range. The taga is created using the method
 * cvmx_get_gr_tag()
 * @nelements: is the number of elements to be held in the resource range.
 */
 ...
 * @tag: is the tag of the global resource range.
 * @nelements: is the number of elements to be allocated.
 * @owner: is a 64 bit number that identifes the owner of this range.
 * @aligment specifes the required alignment of the returned base number.
 * Returns returns the base of the allocated range. -1 return value indicates
 * failure.
 */
 ...
 * @tag: is the tag of the global resource range.
 * @nelements: is the number of elements to be allocated.
 * @owner: is a 64 bit number that identifes the owner of the allocated
 * elements.
 * @allocated_elements: returns indexs of the allocated entries.
 ...
 * @nelements: is the number of elements that are to be freed.
 * Returns returns 0 if successful and -1 on failure.
 */
 ...
 * specified tag.
 * @tag: is the tag of the global resource range.
 * @bases: is an array containing the bases to be freed.
 * @nelements: is the number of elements that are to be freed.
 * Returns returns 0 if successful and -1 on failure.
 */
 ...
 * specified tag.
 * @tag: is the tag of the global resource range.
 * @owner: is the owner of resources that are to be freed.
 * Returns returns 0 if successful and -1 on failure.
 */
